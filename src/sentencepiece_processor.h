...
//
    ...
    #endif
#endif
#endif //_PLATFORMDEFINES__H

inline char16_t* str16cpy(char16_t* destination, const char16_t* source)
{
...
extern "C" DLL_EXPORT sentencepiece::SentencePieceProcessor * CreateProcessor();

extern "C" DLL_EXPORT int Load(
        sentencepiece::SentencePieceProcessor * processor, const char* path);

extern "C" DLL_EXPORT char* Nothing(const char* input);

extern "C" DLL_EXPORT char* Encode(
        sentencepiece::SentencePieceProcessor * processor, const char* input);

extern "C" DLL_EXPORT char* Decode(
        sentencepiece::SentencePieceProcessor * processor, const char* input);

extern "C" DLL_EXPORT void DisposeProcessor(
